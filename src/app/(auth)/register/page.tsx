            ...
            <div
                ...
                <form className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div>
                        ...
                        <input type="text" name="fullname" id="fullname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Bagas Ramadhan" required />
                    </div>
                    <div>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        ...
                        <Link 
                        href="/login" className="text-blue-700 hover:underline dark:text-blue-500"
